...
export const generateAppointmentReceipt = (appointment: AppointmentData) => {
  ...
  doc.setFont('helvetica', 'normal')
  doc.setFontSize(10)
  doc.text('• Llegar 15 minutos antes del turno', 25, 237)
  doc.text('• Traer documento de identidad', 25, 243)
  doc.text('• Consultar restricciones pre-tratamiento', 25, 249)
  ...
  doc.text('Conserve este documento hasta la realización de su turno estético.', 105, 285, { align: 'center' })
